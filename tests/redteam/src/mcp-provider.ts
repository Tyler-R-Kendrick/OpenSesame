 ...
 * `docs/security/audits/2026-08-08-mcp-endpoint-fences.md`, and
 * `docs/security/audits/2026-08-08-mcp-resource-scope.md` for the bug classes
 * this reproduces.
 *
    ...
    if (!Array.isArray(vars.calls) || vars.calls.length === 0) {
      return {
        error:
          ...
          "of { tool, params } — see tests/redteam/tests/*.yaml for examples.",
      };
    }
