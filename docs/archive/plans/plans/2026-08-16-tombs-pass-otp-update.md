...
| `docs/research/competitors/tomb.md` | Competitor note |
| `docs/research/competitors/pass.md` | otp/update/tomb bullets |
...
**Files:** `docs/research/competitors/tomb.md`, `pass.md`, `docs/adr/0038-…`, `PRODUCT.md`, Pages README if needed
