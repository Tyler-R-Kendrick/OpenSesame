...
> `docs/archive/prompts/one-shot-doppler-nats-prompt.md` (WP-B/C/D/E were
...
Finish OpenSesame's Doppler capability parity (ADR 0041, `docs/research/competitors/doppler.md`):
...
- **Capability parity, not a clone** (`docs/research/competitors/doppler.md`). Agents
...
- `encrypted_item_revisions` table (`crates/storage/migrations/0001_init.sql:147`;
...
`crates/storage/migrations/0011_secret_configs.sql` (owner: WP-2):
...
`crates/storage/migrations/0012_secret_changelog.sql` (owner: WP-2): append-only
...
`crates/storage/migrations/0013_rotation.sql` (owner: WP-2):
...
`crates/storage/migrations/0014_webhook_targets.sql` (owner: WP-2):
...
**OWNS:** `docs/adr/0052|0053|0054-*.md`, `docs/research/competitors/doppler.md`
(status/mapping updates), `docs/archive/prompts/one-shot-doppler-nats-prompt.md`
...
tests.
**READS:** `encrypted_item_revisions` DDL (`crates/storage/migrations/0001_init.sql:147`),
