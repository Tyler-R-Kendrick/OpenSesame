...
| Enpass | **Craft bar (vault sync)** — [ADR 0143](../../adr/0143-tailnet-vault-sync.md) | Password manager that syncs through the person's own storage (cloud, WebDAV, folder, desktop Wi-Fi Sync Server) with a client-side merge; model for the tailnet drive | [`enpass.md`](enpass.md) |
