...
([docs/reference/reuse.md](../../reference/reuse.md) "Evaluated / adapter-only"): `op://` is
...
| `op://vault/item/field` | **Evaluated and rejected as the agent API** — materializes into the process; ConnectionRef + Intent instead ([docs/reference/reuse.md](../../reference/reuse.md)) |
