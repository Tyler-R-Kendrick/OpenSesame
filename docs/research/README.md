...
names the ADR it fed.

| Page | Fed |
|---|---|
| [Competitors and peers](competitors/index.md) | Positioning in [PRODUCT.md](../../PRODUCT.md): 1Password, Bitwarden, KeePass, `pass`, Infisical, Doppler, HashiCorp Vault, Nango, SOPS, age, Tailscale and others — each marked as craft bar, peer, study or consume target. |
