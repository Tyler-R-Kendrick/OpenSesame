...
- Remaining open: standing matrix honesty (GA-O-04) — never closes. Self-review residuals: fabric unsupported shuttle/OpenBao, Identity lineage/projector E2E (INV-REVOCATION / INV-CONSISTENCY).
