...
| **GA-F** — policy & OpenFGA | The authorization-model delta and proof that it is additive | `policy/openfga/model.fga`, `packages/policy` | `GA-F-01` … `GA-F-04` |
...
| **GA-P** — client plane | Local share-grant alignment, Access surfaces, no-backend gating | `apps/pages/src/lib/local-share-grants.ts`, `apps/pages/src/sections`, `apps/pwa` | `GA-P-01` … `GA-P-04` |
...
| **GA-Q** — quality & evidence | Structural gates, test plan, visual/behavioural evidence | `quality-baseline.json`, `docs/validation`, `docs/evidence` | `GA-Q-01` … `GA-Q-03` |
