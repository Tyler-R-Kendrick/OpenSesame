...
- **Scripts, budgets, baselines, design lint:** root `dev` (done, step 13) and `quality:bundle` filters, `tools/quality/bundle-budgets.json`, `quality-baseline.json` entries, `design-lint.mjs` roots, `task-security-battle-test.sh`.
