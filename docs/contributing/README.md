...
| **Bundle budgets** | Builds `apps/pages`, `apps/pwa` and `apps/console`, checks [`tools/quality/bundle-budgets.json`](../../tools/quality/bundle-budgets.json), and runs the Pages browser gates in Chromium: WebMCP, keyboard, mobile, local IAM, SIOPv2. |
