...
| Evidence | File |
| --- | --- |
| Every connector × method, created through the real relay, authorized for a person against a strict OAuth provider emulator, and its token acquired and accepted by the service's verify call — 220 paths, 185 services, all verified | [`conformance.json`](conformance.json) |
