...
| SB-058 cloud KMS live | — (gate `scripts/test/verify-sops-cloud-live.mjs`) | INTEROP | `pnpm verify:sops-cloud-live` | blocked | `cloud-live.json` | no disposable AWS/Azure/GCP credentials in this environment; browser engine does not call cloud KMS today |
