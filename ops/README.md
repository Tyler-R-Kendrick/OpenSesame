...
| [`nats/`](nats) | NATS server profiles: plaintext loopback for development, client mTLS (`verify`), certificate mapping (`verify_and_map`), auth callout, and the one tested server-to-server topology. |
