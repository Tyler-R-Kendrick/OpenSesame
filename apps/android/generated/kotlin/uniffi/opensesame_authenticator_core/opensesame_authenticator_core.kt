...
package uniffi.opensesame_authenticator_core
   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.ffi_opensesame_authenticator_core_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.ffi_opensesame_authenticator_core_rustbuffer_free(buf, status)
        }
    }
...
private fun findLibraryName(componentName: String): String {
    ...
    return "opensesame_authenticator_core"
}
...
internal object IntegrityCheckingUniffiLib {
    init {
        Native.register(IntegrityCheckingUniffiLib::class.java, findLibraryName(componentName = "opensesame_authenticator_core"))
...
internal object UniffiLib {
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_u8(`handle`: Long,
    ): Unit
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_i8(`handle`: Long,
    ): Unit
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_u16(`handle`: Long,
    ): Unit
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_i16(`handle`: Long,
    ): Unit
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_u32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_i32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_u64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_i64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_f32(`handle`: Long,
    ): Unit
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_f64(`handle`: Long,
    ): Unit
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_rust_buffer(`handle`: Long,
    ): Unit
    ...
    external fun ffi_opensesame_authenticator_core_rust_future_cancel_void(`handle`: Long,
    ): Unit
...
private fun uniffiCheckContractApiVersion(lib: IntegrityCheckingUniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_opensesame_authenticator_core_uniffi_contract_version()
 ...
 * @suppress
 */
public object FfiConverterTypePlatformInvocation: FfiConverterRustBuffer<PlatformInvocation> {
    override fun read(buf: ByteBuffer): PlatformInvocation {
        return PlatformInvocation(
            FfiConverterTypeInvocationKind.read(buf),
            FfiConverterString.read(buf),
            FfiConverterString.read(buf),
        )
    }

    override fun allocationSize(value: PlatformInvocation) = (
            FfiConverterTypeInvocationKind.allocationSize(value.`kind`) +
            FfiConverterString.allocationSize(value.`payload`) +
            FfiConverterString.allocationSize(value.`protocolUri`)
    )

    override fun write(value: PlatformInvocation, buf: ByteBuffer) {
            FfiConverterTypeInvocationKind.write(value.`kind`, buf)
            FfiConverterString.write(value.`payload`, buf)
            FfiConverterString.write(value.`protocolUri`, buf)
    }
}
...
public object FfiConverterTypeAuthenticatorError : FfiConverterRustBuffer<AuthenticatorException> {
    override fun read(buf: ByteBuffer): AuthenticatorException {
        ...
        return when(buf.getInt()) {
            ...
            2 -> AuthenticatorException.UnverifiedInvocationOrigin()
            3 -> AuthenticatorException.UnsupportedInvocation()
            4 -> AuthenticatorException.ForbiddenInvocationParameter()
            5 -> AuthenticatorException.InvalidInvocationPayload()
            6 -> AuthenticatorException.InvalidInvocationPayloadValue()
            7 -> AuthenticatorException.InsecureRequestUri()
            8 -> AuthenticatorException.PrivateRequestUri()
            9 -> AuthenticatorException.UserVerificationRequired()
            10 -> AuthenticatorException.WrongDevice()
            else -> throw RuntimeException("invalid error enum value, something is very wrong!!")
        }
    }

    override fun allocationSize(value: AuthenticatorException): ULong {
        return when(value) {
            is AuthenticatorException.InvalidAuthenticatorOrigin -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is AuthenticatorException.UnverifiedInvocationOrigin -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is AuthenticatorException.UnsupportedInvocation -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is AuthenticatorException.ForbiddenInvocationParameter -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is AuthenticatorException.InvalidInvocationPayload -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is AuthenticatorException.InvalidInvocationPayloadValue -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is AuthenticatorException.InsecureRequestUri -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is AuthenticatorException.PrivateRequestUri -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is AuthenticatorException.UserVerificationRequired -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is AuthenticatorException.WrongDevice -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
        }
    ...
    override fun write(value: AuthenticatorException, buf: ByteBuffer) {
        when(value) {
            is AuthenticatorException.InvalidAuthenticatorOrigin -> {
                buf.putInt(1)
                Unit
 ...
 * @suppress
 */
public object FfiConverterTypeInvocationKind: FfiConverterRustBuffer<InvocationKind> {
    override fun read(buf: ByteBuffer) = try {
        InvocationKind.values()[buf.getInt() - 1]
    } catch (e: IndexOutOfBoundsException) {
        throw RuntimeException("invalid enum value, something is very wrong!!", e)
    }

    override fun allocationSize(value: InvocationKind) = 4UL

    override fun write(value: InvocationKind, buf: ByteBuffer) {
         ...
         */
    @Throws(AuthenticatorException::class) fun `validatePlatformInvocation`(`authenticatorOrigin`: kotlin.String, `raw`: kotlin.String): PlatformInvocation {
