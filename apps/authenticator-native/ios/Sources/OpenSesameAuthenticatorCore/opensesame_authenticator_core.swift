...
#if canImport(opensesame_authenticator_coreFFI)
import opensesame_authenticator_coreFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_opensesame_authenticator_core_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_opensesame_authenticator_core_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureOpensesameAuthenticatorCoreInitialized()
 ...
 */
public struct PlatformInvocation: Equatable, Hashable {
...
#if compiler(>=6)
extension PlatformInvocation: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypePlatformInvocation: FfiConverterRustBuffer {
    ...
    public static func write(_ value: PlatformInvocation, into buf: inout [UInt8]) {
        FfiConverterTypeInvocationKind.write(value.kind, into: &buf)
        FfiConverterString.write(value.payload, into: &buf)
        FfiConverterString.write(value.protocolUri, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypePlatformInvocation_lift(_ buf: RustBuffer) throws -> PlatformInvocation {
    return try FfiConverterTypePlatformInvocation.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypePlatformInvocation_lower(_ value: PlatformInvocation) -> RustBuffer {
    return FfiConverterTypePlatformInvocation.lower(value)
}
...
#if compiler(>=6)
extension AuthenticatorError: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeAuthenticatorError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AuthenticatorError {
        ...
        case 4: return .ForbiddenInvocationParameter
        case 5: return .InvalidInvocationPayload
        case 6: return .InvalidInvocationPayloadValue
        case 7: return .InsecureRequestUri
        case 8: return .PrivateRequestUri
        case 9: return .UserVerificationRequired
        case 10: return .WrongDevice
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeAuthenticatorError_lift(_ buf: RustBuffer) throws -> AuthenticatorError {
    return try FfiConverterTypeAuthenticatorError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeAuthenticatorError_lower(_ value: AuthenticatorError) -> RustBuffer {
...
#if compiler(>=6)
extension InvocationKind: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeInvocationKind: FfiConverterRustBuffer {
    typealias SwiftType = InvocationKind
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeInvocationKind_lift(_ buf: RustBuffer) throws -> InvocationKind {
    return try FfiConverterTypeInvocationKind.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeInvocationKind_lower(_ value: InvocationKind) -> RustBuffer {
 ...
 */
public func validatePlatformInvocation(authenticatorOrigin: String, raw: String)throws  -> PlatformInvocation  {
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_opensesame_authenticator_core_uniffi_contract_version()
...
public func uniffiEnsureOpensesameAuthenticatorCoreInitialized() {
