...
fn git_bin() -> String {
    named::binary("git-credential-opensesame")
}
...
fn docker_bin() -> String {
    named::binary("docker-credential-opensesame")
}
...
fn aws_bin() -> String {
    named::binary("opensesame-credential-process")
}
...
fn kube_bin() -> String {
    named::binary("opensesame-kube-exec")
}
