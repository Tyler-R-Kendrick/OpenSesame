...
const GOAL_CONTEXT_ROUTES = new Map(
  Object.entries({
    ...
    "settings.secret-config": ["/settings/connections"],
    ...
    "browser.pair": ["/connections", "/settings/connections"],
    "browser.authenticate": ["/connections", "/settings/connections"],
    "browser.revoke": ["/connections", "/settings/connections"],
    "configs.permissions": ["/settings/connections"],
