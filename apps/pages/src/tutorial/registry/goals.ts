...
export const GUIDE_GOALS: readonly GuideGoalDescriptor[] = [
  ...
  },
  {
    ...
    guide: [
      "guide/1",
      'goal "unlock.open"',
      'say "The vault is sealed on this device. Unlock it here with a passkey, PIN or master password."',
      'focus "unlock.submit" "This opens the vault. The method above it is the challenge it will run." side=top',
  ...
  },
  {
    ...
    guide: [
      ...
      'focus "unlock.signin" "Pick the provider that vouches for you. A custom issuer is the globe." side=bottom',
  ...
  },
  {
    ...
    guide: [
      "guide/1",
      'goal "access.claim"',
      'say "A claim code is spent once. Entering it attaches the grant to this person or agent."',
      'focus "access.requests" "Offers and inbound claims live under Requests." side=bottom',
      'hint "access.claim" "The claim field is on this tab." side=top',
      "end",
    ].join("\n"),
  },
  {
...
export const CAPABILITY_TUTORIALS: Readonly<Record<string, GuideGoalId>> = {
  ...
  "changelog.read": "settings.backup",
