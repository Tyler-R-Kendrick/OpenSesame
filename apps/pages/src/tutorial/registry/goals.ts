...
export const GUIDE_GOALS: readonly GuideGoalDescriptor[] = [
  ...
  },
  {
    ...
    guide: [
      ...
      'success "The Sign in tab says you are signed out. Sign in again from there, or continue as a guest."',
      "end",
    ].join("\n"),
  },
  {
    ...
    guide: [
      ...
      'wait target "shell.account" event=activate timeout=30000',
      'success "Choose the account to sign in with on the Sign in tab."',
      "end",
    ].join("\n"),
  },
  {
