...
/**
 * Sandboxed agent runs, and watching one (ADR 0078).
 *
...
function toRun(raw: JsonObject): AgentRun | null {
  ...
  return {
    ...
    controlState: controlState as ControlState,
 ...
 * sequence held to tail, or -1 to read from the start (ADR 0078 §1).
 */
 ...
 * be interrupted (ADR 0078 §6). Queued is reported rather than hidden: a
