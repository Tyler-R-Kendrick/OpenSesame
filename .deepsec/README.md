...
Currently configured project: `opensesame` (target: `..`).
...
original init command. Checkpoints in `data/opensesame/setup/setup-state.json`
...
on Opus by default). Run state goes to `data/opensesame/`.
