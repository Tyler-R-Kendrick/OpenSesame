...
| [`bitwarden-server`](bitwarden-server) | Bitwarden-compatible server: Bitwarden clients against the Host, Argon2id, a replaceable server hash ([ADR 0140](../docs/adr/0140-bitwarden-compatible-server.md)). |
