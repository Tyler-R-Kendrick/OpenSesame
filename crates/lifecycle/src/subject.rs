...
impl SubjectKind {
    ...
    pub const fn renewable(self) -> bool {
        match self {
            ...
            | Self::StorePath
            | Self::Signer
            // Renewing a web login is the entire point of the kind: the
            // platform changes a password the user cannot be expected to
            // change on a schedule themselves (ADR 0076).
            | Self::WebLogin => true,
