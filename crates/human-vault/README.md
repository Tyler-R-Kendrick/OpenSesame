...
the root-protection model shared by browser and native clients.
...
- **Used by:** [`opensesame-sealed-store`](../sealed-store) (envelopes,
  ...
  [`apps/cli`](../../apps/cli) (`vault_migration.rs`), and the fuzz harness in
...
- This is one of two vault formats: the Pages tomb uses PBKDF2 and AES-GCM, and
  converging them is out of scope (ADR 0133).
