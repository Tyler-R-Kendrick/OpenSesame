...
use crate::{
    assert_token_presentation, decode_dpop_proof, reject_dpop_bound_as_bearer,
    sign_dpop_proof, AuthorizedProofRequest, DpopClaims, DpopValidator, InMemoryReplayCache,
    KeyCustodyProvider, LocalSoftwareKeyCustodyProvider, ProofError,
};
use base64::Engine;
use jsonwebtoken::EncodingKey;
use opensesame_domain::{
    ProofPurpose, ProtocolProfile, TokenPresentation, PROFILE_OPENSESAME_TASK_DPOP_RFC9449_V1,
    TaskRunId,
};
...
fn dpop_validation_success() {
    ...
    let proof =
        sign_dpop_proof(&jwk, &encoding_key, &claims).expect("sign proof");
