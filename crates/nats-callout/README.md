...
| `service`: `serve`, `CalloutStats`, `SERVICE_NAME` | The NATS Services API registration: `$SRV.PING\|INFO\|STATS` discovery, allowed/denied/dropped stats, up to `MAX_IN_FLIGHT` concurrent decisions per instance (ADR 0140) |
