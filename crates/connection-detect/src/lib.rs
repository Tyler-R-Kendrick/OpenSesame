...
pub const ALIASES: &[AliasEntry] = aliases![
    ...
    ("twilio", "from_number") => &["TWILIO_FROM_NUMBER", "TWILIO_PHONE_NUMBER"],
    ("messagebird", "api_key") => &["MESSAGEBIRD_API_KEY"],
    ("vonage", "api_key") => &["VONAGE_API_KEY", "NEXMO_API_KEY"],
    ("vonage", "api_secret") => &["VONAGE_API_SECRET", "NEXMO_API_SECRET"],
    ("plivo", "auth_id") => &["PLIVO_AUTH_ID"],
    ("plivo", "auth_token") => &["PLIVO_AUTH_TOKEN"],
