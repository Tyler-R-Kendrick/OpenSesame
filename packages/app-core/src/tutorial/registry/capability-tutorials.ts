...
export const CAPABILITY_TUTORIALS = {
  ...
  "identity.account_factors.list": "identity.account-factors",
  "identity.account_factors.enroll": "identity.account-factors",
  "identity.account_factors.remove": "identity.account-factors",
