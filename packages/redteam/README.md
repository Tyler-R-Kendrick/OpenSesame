...
| Credential exfiltration via an echoing upstream | [`tests/credential-exfiltration.yaml`](tests/credential-exfiltration.yaml) | [`docs/security/audit-2026-08-08-mcp-agent-boundary.md`](../../docs/security/audit-2026-08-08-mcp-agent-boundary.md) and [`docs/security/audit-2026-08-22-mcp-response-minimization.md`](../../docs/security/audit-2026-08-22-mcp-response-minimization.md): per-tool response allowlists plus `forAgent`/`scrubLocalSecrets`. |
