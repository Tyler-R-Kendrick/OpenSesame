...
ALTER TABLE "projects" ADD CONSTRAINT "projects_kind_check" CHECK ("projects"."kind" in ('personal','standard','temporary'));--> statement-breakpoint
...
CREATE INDEX "project_memberships_principal_id_idx" ON "project_memberships" USING btree ("principal_id");
