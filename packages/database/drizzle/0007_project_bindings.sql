...
CREATE UNIQUE INDEX IF NOT EXISTS "projects_owner_personal_slug_uidx" ON "projects" USING btree ("owner_principal_id","slug") WHERE "slug" = 'personal' and "owner_principal_id" is not null;
